...
trait BestAddonFormElements
{
    ...
    public static function select($name = '', $label ='', $options = array(), $extra = '', $selected = array(), $addNone = '')
    {
        ...
        foreach ($options as $key => $val) {
            ...
            if (is_array($val)) {
                ...
                $output .= '<option value="'.$va.'"'.(in_array($va, $selected) ? ' selected="selected"' : '').'>'.(stripos($extra, 'fontWeASome') !== false ? ' &lt;i class="fas fa-'.$val.'"&gt;&lt;/i&gt;' : (stripos($extra, 'image') !== false ? '&lt;i style="--background:url(../previews/'.str_replace('style', '', $val).'.jpg)"&gt;&lt;/i&gt;' : (string) $val))."</option>";
            }
        }
     ...
     */
    public static function cssAnimation($isOut=false, $animateV4=false)
    {
        $in4x = array("animate__bounce","animate__flash","animate__pulse","animate__rubberBand","animate__shakeX","animate__shakeY","animate__headShake","animate__swing","animate__tada","animate__wobble","animate__jello","animate__heartBeat","animate__backInDown","animate__backInLeft","animate__backInRight","animate__backInUp","animate__bounceIn","animate__bounceInDown","animate__bounceInLeft","animate__bounceInRight","animate__bounceInUp","animate__fadeIn","animate__fadeInDown","animate__fadeInDownBig","animate__fadeInLeft","animate__fadeInLeftBig","animate__fadeInRight","animate__fadeInRightBig","animate__fadeInUp","animate__fadeInUpBig","animate__fadeInTopLeft","animate__fadeInTopRight","animate__fadeInBottomLeft","animate__fadeInBottomRight","animate__flip","animate__flipInX","animate__flipInY","animate__lightSpeedInRight","animate__lightSpeedInLeft","animate__rotateIn","animate__rotateInDownLeft","animate__rotateInDownRight","animate__rotateInUpLeft","animate__rotateInUpRight","animate__hinge","animate__jackInTheBox","animate__rollIn","animate__zoomIn","animate__zoomInDown","animate__zoomInLeft","animate__zoomInRight","animate__zoomInUp","animate__slideInDown","animate__slideInLeft","animate__slideInRight","animate__slideInUp");
        $out4x = array("animate__backOutDown","animate__backOutLeft","animate__backOutRight","animate__backOutUp","animate__bounceOut","animate__bounceOutDown","animate__bounceOutLeft","animate__bounceOutRight","animate__bounceOutUp","animate__fadeOut","animate__fadeOutDown","animate__fadeOutDownBig","animate__fadeOutLeft","animate__fadeOutLeftBig","animate__fadeOutRight","animate__fadeOutRightBig","animate__fadeOutUp","animate__fadeOutUpBig","animate__fadeOutTopLeft","animate__fadeOutTopRight","animate__fadeOutBottomRight","animate__fadeOutBottomLeft","animate__flipOutX","animate__flipOutY","animate__lightSpeedOutRight","animate__lightSpeedOutLeft","animate__rotateOut","animate__rotateOutDownLeft","animate__rotateOutDownRight","animate__rotateOutUpLeft","animate__rotateOutUpRight","animate__rollOut","animate__zoomOut","animate__zoomOutDown","animate__zoomOutLeft","animate__zoomOutRight","animate__zoomOutUp","animate__slideOutDown","animate__slideOutLeft","animate__slideOutRight","animate__slideOutUp");
        $in3x = array("fadeIn","fadeInDown","fadeInDownBig","fadeInLeft","fadeInLeftBig","fadeInRight","fadeInRightBig","fadeInUp","fadeInUpBig","rollIn","flipInX","flipInY","rotateIn","rotateInDownLeft","rotateInDownRight","rotateInUpLeft","rotateInUpRight","zoomIn","zoomInDown","zoomInLeft","zoomInRight","zoomInUp","bounceIn","bounceInDown","bounceInLeft","bounceInRight","bounceInUp","flash","pulse","rubberBand","shake","swing","tada","wobble","jello", "heartBeat","slideInUp","slideInDown","slideInLeft","slideInRight", "hinge","jackInTheBox");
        $out3x = array("fadeOut","fadeOutDown","fadeOutDownBig","fadeOutLeft","fadeOutLeftBig","fadeOutRight","fadeOutRightBig","fadeOutUp","fadeOutUpBig","rollOut","flipOutX","flipOutY","rotateOut","rotateOutDownLeft","rotateOutDownRight","rotateOutUpLeft","rotateOutUpRight","zoomOut","zoomOutDown","zoomOutLeft","zoomOutRight","zoomOutUp","bounceOut","bounceOutDown","bounceOutLeft","bounceOutRight","bounceOutUp","slideOutUp","slideOutDown","slideOutLeft","slideOutRight");
        return $isOut ? self::arrayCombine($animateV4 ? $out4x : $out3x, 1) : self::arrayCombine($animateV4 ? $in4x : $in3x, 1);
    }
    ...
    /**
     * Parse strings from a language file INI.
     *
    ...
    public static function parseIniFile($fileName)
    {
        ...
        // Check the parse_ini_file is enabled
    ...
    public static function _l($string)
    {
        $key = strtoupper($string);
        $text = self::parseIniFile(dirname(__FILE__).'/batext.en-gb.ini');
        if (isset($text[$key])) {
            $string = $text[$key];
    ...
    public static function l($label = '', $desc = false)
    {
        ...
        return self::_l('BAEXT_'.$label).((bool)$desc ? '<i class="ba-tip" title="'.self::_l('BAEXT_'.$label.'_DESC').'">?</i>' : '');
    }
